...
import com.bosandroidapp.aopayfinance.kioskmode.imposeRestrictions
...
fun List<com.bosandroidapp.aopayfinance.data.model.loginsignup.CustomerDataItem?>.getLoansStringObject(): String {
    val arr = JSONArray()
    this.forEach {
        it?.let {
