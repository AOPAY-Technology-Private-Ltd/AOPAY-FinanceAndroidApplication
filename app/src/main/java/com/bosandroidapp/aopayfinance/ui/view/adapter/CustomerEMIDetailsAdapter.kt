...
import com.bosandroidapp.aopayfinance.ui.view.activity.customer.CustomerEMIStatusReport
...
class CustomerEMIDetailsAdapter( var context:Context,var customerLoanEmiDetailsList : MutableList<com.bosandroidapp.aopayfinance.data.model.loginsignup.CustomerDataItem?>?): RecyclerView.Adapter<CustomerEMIDetailsAdapter.ViewHolder>() {
