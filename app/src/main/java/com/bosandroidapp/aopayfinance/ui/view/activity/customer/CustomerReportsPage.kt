...
import com.bosandroidapp.aopayfinance.databinding.ActivityCustomerReportsPageBinding
...
class CustomerReportsPage : BaseActivity() {
    ...
    var ReportDataList: MutableList<com.bosandroidapp.aopayfinance.data.model.loginsignup.reports.ReportsDataItem> =
        mutableListOf()
