...
class CustomerEMIPage : AppCompatActivity() {
    ...
    var FilterDataList : MutableList<com.bosandroidapp.aopayfinance.data.model.loginsignup.CustomerDataItem?>? = mutableListOf()
    ...
    fun setDataOnView(customerLoanEmiDetailsList : MutableList<com.bosandroidapp.aopayfinance.data.model.loginsignup.CustomerDataItem?>?){
